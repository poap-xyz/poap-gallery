          ...
          <div className="social-icons">
            ...
            >
              <img
                ...
                src={twitterHover ? TwitterLogoBlue : TwitterLogo}
                alt="Twitter"
              />
            </a>
            <a
            ...
            >
              <img
                ...
                src={githubHover ? GithubLogoBlue : GithubLogo}
                alt="Github"
              />
            </a>
            <a
            ...
            >
              <img
                ...
                src={telegramHover ? TelegramLogoBlue : TelegramLogo}
                alt="Telegram"
              />
            </a>
            <a
              href="https://discord.gg/fcxW4yR"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                ...
                src={discordHover ? DiscordLogoBlue : DiscordLogo}
                alt="Discord"
              />
            </a>
            <a
              href="https://reddit.com/r/poap"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                ...
                src={redditHover ? RedditLogoBlue : RedditLogo}
                alt="Reddit"
              />
            </a>
          </div>
